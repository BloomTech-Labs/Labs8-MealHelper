...
export const recipesReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case ADDED_RECIPES:
			...
			return { ...state, addingRecipe: false, recipes: action.payload };
		case ADDING_RECIPE_ERRORS:
		...
		case GOT_RECIPE:
			return { ...state, gettingRecipe: false, meals: action.payload };
		...
		case GOT_RECIPES:
			//Returns the recipe ID
			return { ...state, gettingRecipes: false, meals: action.payload };
		case GETTING_RECIPE_ERRORS:
			//Shoots off if there is an error logging a recipe
			return { ...state, gettingRecipes: false, error: action.payload };
		case PUTTING_RECIPE:
			//Deleting a recipe
