...
exports.up = function(knex, Promise) {
    return Promise.all([ 
        ...
        users.integer('zip', 5);
        users.string('health condition', 20).notNullable();
        ...
        recipe.integer('ingredients_id').references('id').inTable('ingredients').onDelete('cascade');
        ...
        ingredients.integer('nutrients_id').references('id').inTable('nutrients').onDelete('cascade');
            }),
        ...
        mealList.increments();
        mealList.integer('recipe_id').references('id').inTable('recipe').onDelete('cascade');
        mealList.integer('user_id').references('id').inTable('users').onDelete('cascade');
        ...
        weather.integer('mealId').references('id').inTable('mealList').onDelete('cascade');
        ...
        alarms.integer('user_id').references('id').inTable('users').onDelete('cascade');
        ...
        notes.integer('mealList_id').references('id').inTable('mealList').onDelete('cascade');
